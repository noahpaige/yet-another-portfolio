...
export default function GhostOfTsushimaContent() {
  return (
    <div className="text-zinc-100 p-6 mx-auto space-y-6 font-serif">
      ...
      <p className="text-lg leading-relaxed text-zinc-300">
        ...
        action game set in feudal Japan. Jin Sakai must choose between honor and
        pragmatism as he fights to liberate his homeland from Mongol invaders.
      </p>
