...
Often referred to as the “Big Five,” this model breaks personality into five traits: **Openness**, **Conscientiousness**, **Extraversion**, **Agreeableness**, and **Neuroticism**. Each NPC is assigned a numerical value (0–1) for each trait, which combine to define their personality.

<Image
  src="/big-five.webp"
  alt="Five-Factor Model of Personality Image"
  width={500}
  captionText="The Five-Factor Model of Personality, AKA the Big Five Personality Traits."
/>
